<?php
  include 'header.php'; 
  $students = $db->query("SELECT * FROM localisation")->fetchAll(PDO::FETCH_ASSOC);

?>
        <div class='main-panel'>
          <div class='content-wrapper text-center'>
            <h2 class="p-3 " style="font-weight: bold;">ENREGISTREMENT DE LA LOCALISATION</h2>
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                <div class="container text-center mt-3">
                  <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#modalinsert">Ajouter une nouvelle localisation</button>
                </div>
                <div class="card-body">
                      ...
                      <form name="formName" action="" method="POST">
                        ...
                        <table id="zero_config" class="table table-striped table-bordered no-wrap">
                            ...
                            <tbody>
                              ...
                              $count++;
                              $id[$count] = $students["idlib"];

                              ?>
                                <tr>
                                    <td><input type="checkbox" id="std" name="sec[]" value="<?php echo $students["idlib"]; ?>"></td>
                                    <td><?php echo $count; ?></td>
                                    <td><?php echo $students["libele"]; ?></td>
                                 
                                    
                                    <td>
                                        <button type="button" class="btn btn-outline-success editstudent p-2" data-toggle="modal" data-name="<?php echo $students["libele"]; ?>"  data-id="<?php echo $students["idlib"]; ?>"  data-target="#exampleModal"> 
                                          <i class="mdi mdi-table-edit"></i>Modifier
                                        </button>
                                        <button type="button" class="btn btn-outline-danger deletestudent p-2" data-name = "<?php echo $students["libele"]; ?>"  data-toggle="modal" data-id="<?php echo $students["idlib"]; ?>" data-target="#myModal"> 
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <div class="card">
                      <div class="card-body">
                        <form class="forms-sample" action="processlocalisation.php" method="POST"enctype="multipart/form-data">
                  ...
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          ...
                          <div class="modal-body" style="height:120px">
                              <form class="form-control" method="POST" action="processlocalisation.php">
